...
attrs, R.styleable.MusicSeekbar, defStyle, 0)

mExampleString = a.getString(
R.styleable.MusicSeekbar_exampleString)
mExampleColor = a.getColor(
R.styleable.MusicSeekbar_exampleColor,
mExampleColor)
 // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
R.styleable.MusicSeekbar_exampleDimension,
mExampleDimension)

if (a.hasValue(R.styleable.MusicSeekbar_exampleDrawable))
{
exampleDrawable = a.getDrawable(
R.styleable.MusicSeekbar_exampleDrawable)
